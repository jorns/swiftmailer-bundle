...
class SwiftmailerExtension extends Extension
{
    ...
    {
        if (isset($mailer['delivery_addresses']) && $mailer['delivery_addresses']) {
            $container->setParameter(sprintf('swiftmailer.mailer.%s.single_address', $name), reset($mailer['delivery_addresses']));
